...
from src.LettersAnalysis import load_letter_position_data, load_letter_data, load_element_data, load_element_position_data
from src.LettersNikud import load_letters_nikud_data
from src.NikudAnalysis import load_nikud_position_data, load_nikud_data
from src.LettersNikudPosition import load_letters_nikud_position_data
    ...
    def analyze_name(self):
        ...
        for i, letter in enumerate(self.normalize_final_letters(self.name)):
            ...
            if letter in letter_position_data and position_key in letter_position_data[letter] and \
                ...
                result.append("\033[94m" + f"{letter}' כאות {position_key}: "
                                           f"{letter_position_data[letter][position_key]}\n\033[0m")
